      ...
      <div className="flex gap-20 m-15">
        <div className="h-132 w-2xl  relative ">
            <form action="" className="flex flex-col gap-1 font-bold m-5 p-5 ">
              Name:<input type="text" required placeholder="Please enter your first name "/>
            {/* Last Name:<input type="text" placeholder="Please enter your last name"/> */}
            Email:<input type="email" required placeholder="Please enter your email" />
            Phone:<input type="tel" required placeholder="Please enter your phone"/>
         ...
         hover:bg-gray-800 transition shadow-md cursor-pointer "
            >Send Message</button>
            </form>
          <div className="absolute left-160 w-1 h-105 rounded-4xl m-15 bottom-4 bg-black "></div>
        </div>
        <div className="font-semibold m-15 p-5 flex-col flex gap-5 cursor-pointer">
          <a className="flex items-center gap-2 h-10 w-10 rounded-b-full">
            <img className="h-8 w-8" src={facebook} />
            facebook.com/deepastudios
          </a>
          <a className="flex items-center gap-2 h-10 w-10 rounded-b-full cursor-pointer">
